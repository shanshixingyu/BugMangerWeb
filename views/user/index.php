...
<?php
$temp = Yii::$app->request->getUrl();
echo '路由地址', $temp;
echo '<br />';
echo '处理后的地址', substr($temp, strpos($temp, '&'));
echo '<br />';
echo \yii\helpers\Url::to(['user/index', 'id' => 5, 'page' => 4, 'per-page' => 8]);
echo '<br />';
echo $dataProvider->getPagination()->getPage();
?>