...
<div class="editProductOrModuleInfo">
    ...
    <div class="editInfoForm">
        ...
        <?php else: ?>
            ...
            <?php echo $form->field($moduleForm, 'introduce', ['template' => '<div class="infoRow"><div class="infoLabel">{label}</div><div class="infoInputArea">{input}</div></div>',])->textarea(['rows' => 6]) ?>

            <?php echo Html::submitButton($isAddModuleView ? '添加' : '修改', ['class' => 'btn btn-primary submitBtn',]) ?>
